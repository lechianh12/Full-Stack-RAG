  ...
  if (isEmpty) {
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 32px' }}>
        ...
        <p style={{ fontSize: '22px', fontWeight: 700, color: '#111827', margin: '0 0 10px' }}>
          Xin chào{username ? `, ${username}` : ''}! 👋
        </p>
        <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: 1.65, maxWidth: '360px' }}>
          Tôi có thể giúp gì cho bạn hôm nay? Chọn tài liệu bên dưới rồi đặt câu hỏi để tôi trả lời dựa trên nội dung tài liệu.
        </p>
      </div>
    );
  }
